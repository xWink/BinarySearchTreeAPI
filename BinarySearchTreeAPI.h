...
/**
 * Prints the entire contents of a binary tree in ascending order.
 ...
 * @param printFunction - a function which takes in a unit of data stored
 *                        within the tree and prints it to the terminal
 */
void printSubtree(BSTNode* node, void (*printFunction)(void* data));
